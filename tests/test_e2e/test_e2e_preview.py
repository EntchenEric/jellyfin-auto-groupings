...
class TestE2EPreview:
    ...
    def test_preview_genre(self, e2e_session) -> None:
    ...
    def test_preview_requires_value(self, e2e_session) -> None:
    ...
    def test_preview_general_search(self, e2e_session) -> None:
