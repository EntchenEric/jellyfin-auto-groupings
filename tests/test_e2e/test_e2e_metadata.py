...
class TestE2EMetadata:
    ...
    def test_metadata_endpoint_returns_success(self, e2e_session) -> None:
        """The metadata endpoint should return status success."""
        result = api_get(e2e_session, "/api/jellyfin/metadata")
        assert result["status"] == "success"

    def test_metadata_has_categories(self, e2e_session) -> None:
    ...
    def test_users_endpoint(self, e2e_session) -> None:
